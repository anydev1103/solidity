 ...
 *
 * The m_store member of RedundantStoreBase is only used with the empty yul string
 * as key in the first dimension.
 */
class RedundantStoreEliminator: public RedundantStoreBase
{
public:
	...
	using RedundantStoreBase::operator();
